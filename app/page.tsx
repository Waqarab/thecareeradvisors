...
export default function Home() {
  ...
  useEffect(() => {
    ...
    }, 4500); // Slightly slower to give the device breathing room
    ...
    <>
      ...
      <div className="flex flex-col min-h-screen bg-[#f8fafc] font-sans selection:bg-blue-100">
        ...
        <section className="relative pt-6 pb-6 lg:pt-8 lg:pb-8 overflow-hidden z-0 flex-1 flex flex-col justify-center">
          ...
          {/* OPTIMIZATION 1: Static Background Elements. 
              Removed framer-motion from massive blurs. Animating blur-[120px] crashes mobile GPUs. */}
          ...
          {/* OPTIMIZATION 2: Static SVG. No continuous javascript animation loop. */}
          ...
          <div className="container max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 relative z-10">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-6">
              ...
              <div className="w-full lg:w-[55%] xl:w-[50%] flex flex-col justify-center text-left space-y-5 lg:space-y-6">
                ...
                {/* OPTIMIZATION 3: Using whileInView instead of isLoaded ternary to prevent massive CPU spike on load */}
                <motion.div 
                ...
                {/* Grouped Feature Cards into one motion div to reduce DOM node animations */}
                <motion.div 
                  initial={{ opacity: 0, y: 10 }} 
                  whileInView={{ opacity: 1, y: 0 }} 
                  viewport={{ once: true }}
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3">
                    <div className="flex -space-x-2.5">
                      ...
                      <img className="w-8 h-8 rounded-full border-2 border-white bg-slate-200" src="https://i.pravatar.cc/100?img=14" alt="Student 4" loading="lazy" />
                    </div>
              ...
              {/* RIGHT COLUMN: Image & Glassmorphism Overlay */}
              <div className="w-full lg:w-[45%] relative flex justify-end items-center mt-6 lg:mt-0">
                
                {/* Made ambient glow static to save GPU memory */}
                ...
                >
                  {/* OPTIMIZATION 4: Simplified Slider Image transitions */}
                  <AnimatePresence mode="wait">
                    <motion.img 
                      ...
                      animate={{ opacity: 1 }}
                      exit={{ opacity: 0.8 }}
                      transition={{ duration: 0.4 }} // Fast crossfade, removed continuous 10s scaling
                      className="absolute inset-0 w-full h-full object-cover"
                    />
                  </AnimatePresence>

                  {/* Floating Modern Stats overlay (Static to save DOM repaints) */}
                  <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 flex flex-row items-center justify-between gap-2 z-10">
                    ...
                    <div className="flex-1 flex items-center gap-2 sm:gap-3 bg-white/90 backdrop-blur-md border border-white/40 p-2 sm:p-3 rounded-xl sm:rounded-2xl shadow-lg">
                    ...
                    <div className="flex-1 flex items-center gap-2 sm:gap-3 bg-slate-900/85 backdrop-blur-md border border-slate-700/50 p-2 sm:p-3 rounded-xl sm:rounded-2xl shadow-lg">
