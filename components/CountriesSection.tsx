...
export default function CountriesSection() {
  ...
  return (
    <section id="universities" className="py-16 md:py-20 bg-background border-t border-border/40 overflow-hidden">
                ...
                >
                  <div className="relative h-56 overflow-hidden bg-muted flex items-center justify-center">
                    ...
                    {uni.image && uni.image.trim() !== "" ? (
                      ...
                      <div className="w-full h-full flex flex-col items-center justify-center bg-slate-100 text-slate-400 z-0">
