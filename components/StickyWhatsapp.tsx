...
export default function StickyWhatsApp() {
  ...
  return (
    <motion.div
      // OPTIMIZATION: Pushed closer to the edge on mobile (bottom-4 left-4)
      className="fixed bottom-4 left-4 md:bottom-6 md:left-6 z-[90] cursor-grab active:cursor-grabbing"
      drag
    ...
    >
      <motion.a
        ...
        className="flex items-center justify-center w-12 h-12 md:w-14 md:h-14 bg-[#25D366] text-white rounded-full shadow-[0_4px_15px_rgba(37,211,102,0.4)] relative"
      ...
      >
        ...
        <svg 
          viewBox="0 0 24 24" 
          fill="currentColor" 
          // OPTIMIZATION: Icon scaled down slightly to fit the smaller button
          className="w-6 h-6 md:w-7 md:h-7 relative z-10 ml-0.5 mt-0.5" 
        >
